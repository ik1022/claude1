...
class Ssd1306 {
public:
    // 디스플레이 치수 (Ssd1306Config에서 참조)
    static constexpr uint8_t DISPLAY_WIDTH = Ssd1306Config::DISPLAY_WIDTH;
    static constexpr uint8_t DISPLAY_HEIGHT = Ssd1306Config::DISPLAY_HEIGHT;
    static constexpr uint8_t PAGES = Ssd1306Config::PAGES;
    static constexpr size_t FRAME_BUFFER_SIZE = Ssd1306Config::FRAME_BUFFER_SIZE;
    static constexpr uint8_t DEFAULT_I2C_ADDR = Ssd1306Config::DEFAULT_I2C_ADDR;

    // SSD1306 명령 정의 (Ssd1306Commands에서 참조)
    static constexpr uint8_t CMD_SET_CONTRAST = Ssd1306Commands::SET_CONTRAST;
    static constexpr uint8_t CMD_SET_NORMAL_DISPLAY = Ssd1306Commands::SET_NORMAL_DISPLAY;
    static constexpr uint8_t CMD_SET_INVERSE_DISPLAY = Ssd1306Commands::SET_INVERSE_DISPLAY;
    static constexpr uint8_t CMD_DISPLAY_OFF = Ssd1306Commands::DISPLAY_OFF;
    static constexpr uint8_t CMD_DISPLAY_ON = Ssd1306Commands::DISPLAY_ON;
    static constexpr uint8_t CMD_SET_ADDRESS_MODE = Ssd1306Commands::SET_ADDRESS_MODE;
    static constexpr uint8_t CMD_SET_COLUMN_ADDRESS = Ssd1306Commands::SET_COLUMN_ADDRESS;
    static constexpr uint8_t CMD_SET_PAGE_ADDRESS = Ssd1306Commands::SET_PAGE_ADDRESS;
